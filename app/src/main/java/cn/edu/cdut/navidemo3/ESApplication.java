...
import cn.edu.cdut.navidemo3.extra.data.ESActivity;
import cn.edu.cdut.navidemo3.extra.data.ESDatabaseAccessor;
import cn.edu.cdut.navidemo3.extra.data.ESIntentService;
import cn.edu.cdut.navidemo3.extra.data.ESLabelStruct;
import cn.edu.cdut.navidemo3.extra.data.ESNetworkAccessor;
import cn.edu.cdut.navidemo3.extra.data.ESSensorManager;
...
public class ESApplication extends Application {
    ...
    public static Context getTheAppContext() {
        //_appContext = MainActivity.getInstance();
//        _appContext = g
        return _appContext;
    }
    ...
    public static class PredeterminedLabels {
        ...
        public boolean is_initiatedByNotification() { return _initiatedByNotification; }

        public boolean is_startedFirstActivityRecording() {
        ...
        public void set_startedFirstActivityRecording(boolean startedFirstActivityRecording) {
            _startedFirstActivityRecording = startedFirstActivityRecording;
        }

        public void setPredeterminedLabels(ESLabelStruct labels, int validForHowManyMinutes, boolean initiatedByNotification,
    ...
    public static PredeterminedLabels _predeterminedLabels = new PredeterminedLabels();
    ...
    public static File getDataDir1() {
    ...
    public static ESSensorManager _sensorManager;
    //private ESWatchProcessor _watchProcessor;
    public static AlarmManager _alarmManager;
