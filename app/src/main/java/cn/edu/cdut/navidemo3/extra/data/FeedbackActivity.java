...
import static cn.edu.cdut.navidemo3.extra.data.ESDatabaseAccessor.getESDatabaseAccessor;
...
import cn.edu.cdut.navidemo3.databinding.ActivityFeedbackBinding;
    ...
    private void presentFeedbackView() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                switch (position) {
                    case ROW_MAIN:
                        intent = new Intent(MainActivity.getInstance(), SelectionFromListActivity.class);
                    ...
                    case ROW_SECONDARY:
                        ...
                        frequentLabels = getESDatabaseAccessor().getFrequentlyUsedLabels(null , ESDatabaseAccessor.ESLabelType.ES_LABEL_TYPE_SECONDARY);
                    ...
                    case ROW_MOOD:
                        ...
                        frequentLabels = getESDatabaseAccessor().getFrequentlyUsedLabels(null , ESDatabaseAccessor.ESLabelType.ES_LABEL_TYPE_MOOD);
                        intent.putExtra(SelectionFromListActivity.FREQUENTLY_USED_LABELS_KEY,frequentLabels);
    ...
    public void addListenerOnButton() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(_parameters._feedbackType == FEEDBACK_TYPE_ACTIVE){
                    Log.d(LOG_TAG,"ACTIVE FEEDBACK");//(ESApplication)getApplication()
