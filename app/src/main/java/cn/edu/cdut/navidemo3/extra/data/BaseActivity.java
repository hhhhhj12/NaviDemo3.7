...
/*        getSupportActionBar().setIcon(R.drawable.ic_launcher_2_foreground);
    ...
    private void displayAlertForActiveFeedback(final ESTimestamp timestampNotification) {
        ...
        builder.setIcon(R.drawable.ic_launcher_foreground).setMessage(ALERT_TEXT_NO_VERIFIED);
...
//        final ESContinuousActivity entireRange = ESDatabaseAccessor.getESDatabaseAccessor().getSingleContinuousActivityFromTimeRange(fromTimestamp,toTimestamp);
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setIcon(R.drawable.ic_launcher_foreground).setMessage(question);
