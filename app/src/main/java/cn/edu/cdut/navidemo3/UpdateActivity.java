...
//更新数据用
public class UpdateActivity extends AppCompatActivity implements View.OnClickListener, TimePickerDialog.OnTimeSetListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.tv_startTime:
                ...
                TimePickerDialog dialog = new TimePickerDialog(UpdateActivity.this,this,
            ...
            case R.id.tv_endTime:
                ...
                TimePickerDialog dialog1 = new TimePickerDialog(UpdateActivity.this,this,
            ...
            switch (v.getId()){
                ...
                case R.id.btn_add:
                    if (tv_startTime.getText().equals("起始时间:")||
                        ...
                        Toast.makeText(UpdateActivity.this,"请输入完整标签",Toast.LENGTH_SHORT).show();
                    }else {
                        LabelModel labelModel = new LabelModel(id,startTime,endTime
                                ,tv_action.getText().toString(),tv_position.getText().toString()
                                ,tv_audio.getText().toString());
                        String s = dbHelper.updateOne(labelModel, tableName);
                        Toast.makeText(UpdateActivity.this,"ADD:"+s,Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    break;
            }
        ...
        alertDialog = builder.setTitle("选择你的"+s)
                .setSingleChoiceItems(strings, 0, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(UpdateActivity.this,"你选择了"+strings[which],Toast.LENGTH_SHORT).show();
